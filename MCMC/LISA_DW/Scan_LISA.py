...
os.popen('cp ./Data_header/LISA_DW.csv ./{}'.format(Data_p)) 

E           = np.log10( 6.83104864410821e+26 )
Vbias       = np.log10( 1.942575876544e+19 )
...
xMC = [E] + [Vbias] + [log10_h2Ext] + [alphaExt] + [log10_h2Gal] + [alphaGal] + [b] + [c]
Dim=len(xMC)
...
for i in range(0,nBatches):
    ...
    if i > 0:
        ...
        E           = 10**p_max[0]
        Vbias       = 10**p_max[1]
        log10_h2Ext = 10**p_max[2]
        alphaExt    = 10**p_max[3]
        log10_h2Gal = 10**p_max[4]
        alphaGal    = 10**p_max[5]
        b           = 10**p_max[6]
        c           = 10**p_max[7]
